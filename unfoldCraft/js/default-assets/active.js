(function ($) {
    ...
    var ufc_window = $(window);

    // ****************************
    // :: 1.0 Preloader Active Code
    // ****************************

    ufc_window.on('load', function () {
    ...
    // *******************************
    if ($.fn.imagesLoaded) {
        $('.ufc-portfolio').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.ufc-portfolio').isotope({
    ...
    // **************************
    ufc_window.on('scroll', function () {
        if (ufc_window.scrollTop() > 0) {
